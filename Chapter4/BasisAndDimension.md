...
$$
S  =  \operatorname{Span}{\mathcal A}_1   =    \operatorname{Span} {\mathcal A}_2 =  \operatorname{Span}{ {\mathcal A}_3} =  \operatorname{Span}{ {\mathcal A}_4}
$$
...
$S = \operatorname{Span}\mathcal{B}=  \Span{\vect{b}_1, \vect{b}_2, \ldots, \vect{b}_r}$.

</li>

<li>

The set $\mathcal{B}=\lbrace\vect{b}_1, \vect{b}_2, \ldots, \vect{b}_r\rbrace$ is linearly independent.
...
where the vector $\vect{e}_j$ stands for the $j$-th column of the $n \times n$ identity matrix $I_n$.
